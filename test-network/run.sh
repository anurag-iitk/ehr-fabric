...
ORDERER_CA=/opt/src/github.com/anurag-iitk/ehr-fabric/ehr-fabric/test-network/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
...
# create a channel
# docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/src/github.com/anurag-iitk/ehr-fabric/ehr-fabric/test-network/crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp" peer0.org1.example.com peer  channel create -o orderer.example.com:7050 -c mychannel -f /channel-artifacts/channel.tx --tls true --cafile /opt/src/github.com/anurag-iitk/ehr-fabric/ehr-fabric/test-network/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
