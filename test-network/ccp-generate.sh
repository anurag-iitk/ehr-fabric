...
echo "$(json_ccp $ORG $P1PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org1.example.com/connection-org1.json
echo "$(yaml_ccp $ORG $P1PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org1.example.com/connection-org1.yaml
...
echo "$(json_ccp $ORG $P1PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org2.example.com/connection-org2.json
echo "$(yaml_ccp $ORG $P1PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org2.example.com/connection-org2.yaml
...
echo "$(json_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org3.example.com/connection-org3.json
echo "$(yaml_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org3.example.com/connection-org3.yaml
echo "$(json_ccp $ORG $P1PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org3.example.com/connection-org3.json
echo "$(yaml_ccp $ORG $P1PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org3.example.com/connection-org3.yaml
...
echo "$(json_ccp $ORG $P1PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org4.example.com/connection-org4.json
echo "$(yaml_ccp $ORG $P1PORT $CAPORT $PEERPEM $CAPEM)" > crypto-config/peerOrganizations/org4.example.com/connection-org4.yaml
